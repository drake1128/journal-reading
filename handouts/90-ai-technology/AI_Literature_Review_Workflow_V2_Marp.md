...
footer: '謝慕揚 MD, PhD, FESC | Leveraging AI for Literature Review — V2 (ACS / Efient) | 2026'
---

<!-- _class: lead -->

# 在 AI 時代運用人工智慧進行文獻回顧 — V2

## 以 ACS 與 Efient (Prasugrel) 為主軸的實戰版
...
**謝慕揚 MD, PhD, FESC**
新竹臺大分院 心血管中心
2026-04-28 (Version 2)

---

# 為什麼有 V2？/ What's New in V2

## 三個重要的調整

- **範例全面換軸**：原本 TEER / TAVI / TriClip 的範例 → 改以 **ACS + Efient (prasugrel)** 為主軸
- **三個臨床範例**：全部與 Efient 相關，含 **ISAR-REACT 5、de-escalation、special populations**
- **重點強化**：
  - 詳細展示 **Claude 進行文獻回顧** 的步驟
  - 教 **如何寫提示詞 (prompt)** 來精修投影片
  - 大幅擴充 **Scientific Skills** 章節 — 把 Claude 當科研助理
...
4. **Scientific Skills** — Claude 內建的「科研工具箱」 ★ 擴充
5. **Prompt Engineering** — 寫好提示詞，把投影片磨亮 ★ 全新
6. **Three Worked Examples** — 全部以 **ACS / Efient** 為核心 ★ 替換
...
*Version 2 · 2026-04-28 · 主軸：ACS / Efient (Prasugrel)*
