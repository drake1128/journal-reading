# Persistent Sciatic Artery：罕見血管變異的診斷與處置
...
- [核心發現摘要](#核心發現摘要)
- [1. 病例呈現](#1-病例呈現)
- [2. 持續性坐骨動脈概述](#2-持續性坐骨動脈概述)
- [3. Pillet-Gauffre 分類系統](#3-pillet-gauffre-分類系統)
- [4. 臨床表現](#4-臨床表現)
- [5. 併發症](#5-併發症)
- [6. 診斷](#6-診斷)
- [7. 治療](#7-治療)
...
- 本案為 82 歲女性（MRN: P07），右側 PSA，介入治療時器械位於 internal iliac artery 內
...
| 發現方式 | 周邊血管介入治療時發現 |
| 關鍵發現 | 介入器械位於 internal iliac artery 內，而非一般的 external iliac → femoral artery 路徑 |
| 操作醫師 | 潘恆宇醫師 |
...
> **Pearl**: 從 angiography 不易直接辨識 PSA，需仔細觀察導管及器械位置。本案器械皆位於 internal iliac artery 內，正常情況下下肢介入應經由 external iliac → common femoral → SFA 路徑。

- **血管攝影 (Angiography)**：顯示 persistent sciatic artery 走向，介入器械位於 internal iliac artery 內
- **電腦斷層 (CT Axial)**：骨盆腔軸向切面，顯示 PSA 解剖位置
- PSA 從 internal iliac artery 延伸，經坐骨大孔至膕動脈
...
> **Pearl**: 由於 PSA 經由 internal iliac artery 供應下肢，介入器械會位於 internal iliac artery 內而非傳統的 external iliac → femoral artery 路徑。這是本病例的關鍵發現。

---

## 3. Pillet-Gauffre 分類系統
...
> **Pearl**: 由於 PSA 的解剖位置特殊（經過坐骨大孔、沿坐骨神經走行），動脈瘤形成後可能壓迫坐骨神經，造成類似坐骨神經痛的症狀，需與椎間盤疾病鑑別。
...
> **Pearl 1**: 診斷線索 — 股動脈搏動減弱但膕動脈搏動正常時，應考慮 PSA

> **Pearl 2**: Cowie's Sign — 臀部搏動性腫塊高度提示 PSA

> **Pearl 3**: 坐姿跛行 — 坐下時症狀加重而非緩解，為 PSA 特徵性表現

> **Pearl 4**: 介入治療 — 器械位於 internal iliac artery 內是重要診斷線索

> **Pearl 5**: 動脈瘤風險 — 高達 48%，需定期追蹤

> **Pearl 6**: 雙側檢查 — 一側發現 PSA 時，需檢查對側（雙側發生率 26%）

> **Pearl 7**: 多專科合作 — 血管外科、介入放射科、影像診斷專家共同評估

---

## 9. 本病例討論

- 本案為 82 歲女性（MRN: P07），右側 PSA，在周邊血管介入治療時發現
...
1. Ahn S, Min SK. Treatment Strategy for Persistent Sciatic Artery and Novel Classification Reflecting Anatomic Status. [*Eur J Vasc Endovasc Surg*. 2016;52(3):360-369.](https://doi.org/10.1016/j.ejvs.2016.07.007)
...
3. Bower EB, et al. Persistent sciatic artery: embryology, pathology, and treatment. [*J Vasc Surg*. 1993;18(2):242-248.](https://doi.org/10.1016/0741-5214(93)90604-K)
4. van Hooft IM, et al. Persistent sciatic artery. [*J Vasc Surg*. 2010;51(4):1066.](https://doi.org/10.1016/j.jvs.2009.09.068)
5. Paraskevas G, et al. Persistent sciatic artery: a systematic review. [*Surg Radiol Anat*. 2015;37(10):1189-1195.](https://doi.org/10.1007/s00276-015-1492-y)
