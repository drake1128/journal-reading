...
\includepdf[pages=-,offset=-0.5cm 0cm]{cover-page-mainz-2024.pdf}
...
\textbf{申請出國進修研究人員計畫說明}

\subsection{個人對進修研究問題之重要性、背景與任務之認識} 
...
\begin{enumerate}
    \item Edge-to-edge repair of mitral valve (M-TEER)
    \item Edge-to-edge repair of tricuspid valve (T-TEER)
    \item Transcatheter aortic valve implantation/replacement (TAVI/TAVR)
\end{enumerate}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/general/fig Prof Stephan.png}
    \caption{教授很具親和力，技術非常好之外，很注重在導管室地團隊氣氛，常常會和同仁擊掌並說sehr gut (非常好)!}
    \label{images/general/fig Prof Stephan}
\end{figure}

\subsection{國際級的訓練中心}
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/general/fig Mainz fellows.png}
    \caption{我在Mainz與Dr. Julian (from Colombia) and Dr. Kabir (from India)一起共事。}
    \label{images/general/fig Mainz fellows}
\end{figure}

\textbf{不另外收費，接受國際學者以self-financing方式參訪}，自行負擔食宿與旅行費用。Mainz心臟中心協助安排住宿大學部的宿舍。其中，不另外收費是很特別的事情。在2024-11月，已有40多位國外醫師申請，並進入排序等著前往Mainz進修。

\subsection{經導管瓣膜治療的手術量}
截至2024-12-22，經由Mainz Heart Valve Center自己的資料庫內，已經完成如下數量的治療:
\begin{itemize}
    \item Mitral-TEER: 2002台
    \item Tricuspid-TEER: 700台
    \item TAVI for AS: 2000+台
\end{itemize}
...
如何提升經導管瓣膜治療的水準?
\begin{itemize}
    \item \textbf{固定開會檢討成效}，Mainz是每天開會，進行Heart Team Meeting, 除討論病患治療選擇，一併討論前一日病患之治療成果與併發症。
    \item \textbf{建立查核表與流程規範}，確保治療作法一致。
    \item \textbf{手術集中管理}，讓兩位TAVI術者經驗>2000例/單一術者。
\end{itemize}

Mainz有幾個作法，與我們不同:
\begin{itemize}
    \item 每位醫師的工作細分，\textbf{薪津由主管統一分配}: 可以確保工作專一，發展方向一致，醫師不會以收入為競爭依據。\textit{之後可考慮參考針對重點發展術式，績效再重新分配之制度}。
    \item \textbf{開放外院醫師帶病患來本院接受治療}，該外院醫師若為本院受訓離開之醫師，直接擔任自己病患的主要術者，由Mainz提供場地，麻醉科，與心臟內科外科醫師現場備援。\textit{可考慮此一作法，促進公立醫院在地服務效能}。
    \item \textbf{心臟科有專屬團隊}，病房總床數120床，配置有R1-R5共60名住院醫師，分屬不同團隊。
    \item 超音波的評估細致而且精確，有標準的評估流程，\textit{之後應加設超音波評估討論會議}。
\end{itemize}
