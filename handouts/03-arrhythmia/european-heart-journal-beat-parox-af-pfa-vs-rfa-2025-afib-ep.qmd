---
title: "European Heart Journal BEAT PAROX-AF PFA vs RFA 2025 Afib EP"
...
脈衝場消融術 vs 射頻消融術治療陣發性心房顫動：BEAT PAROX-AF 試驗\
[Eur Heart J 2025. DOI: 10.1093/eurheartj/ehaf1115](https://doi.org/10.1093/eurheartj/ehaf1115)\
...
## RFA 組：CLOSE Protocol

- 設備：CARTO® 3 System（Biosense Webster）

- 導管：Contact force-sensing catheter（SmartTouch® 或 SmartTouch® Surround Flow）
...
2.  Blanking period 後無 $\geq$ 30 秒心房心律不整復發
...
::: tcolorbox
PFA 手術時間較短約 40 分鐘，左心房停留時間較短約 38 分鐘，但透視時間較長約 5 分鐘。
:::
...
- PV 狹窄 $\geq$ 70%：PFA 0% vs RFA 1.9%（2/106 例）

- PV 狹窄 $\geq$ 50%：PFA 0% vs RFA 11.3%（12/106 例）
...
1.  PFA 與優化的 RFA（CLOSE protocol）在陣發性 AF 治療上療效相當
...
::: tcolorbox
PFA 在有經驗中心是安全有效的 AF 消融選項，對 PV 的保護效果可能優於傳統熱能消融。
:::

# 參考文獻

1.  Jais P, Neuzil P, Scherr D, et al. Pulsed field vs radiofrequency ablation for paroxysmal atrial fibrillation: the BEAT PAROX-AF trial. [*Eur Heart J*. 2025. DOI: 10.1093/eurheartj/ehaf1115](https://doi.org/10.1093/eurheartj/ehaf1115)
...
4.  Reichlin T, et al. Pulsed field or cryoballoon ablation for paroxysmal atrial fibrillation. [*N Engl J Med*. 2025;392:1497-507.](https://doi.org/10.1056/NEJMoa2502280)

5.  Phlips T, et al. Improving procedural and one-year outcome after contact force-guided pulmonary vein isolation: the role of interlesion distance, ablation index, and contact force variability in the 'CLOSE'-protocol. [*Europace*. 2018;20:f419-27.](https://doi.org/10.1093/europace/eux376)

6.  Ekanem E, et al. Safety of pulsed field ablation in more than 17,000 patients with atrial fibrillation in the MANIFEST-17K study. [*Nat Med*. 2024;30:2020-9.](https://doi.org/10.1038/s41591-024-03114-3)
